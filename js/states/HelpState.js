...
export default class HelpState extends BackToMenuState {
  ...
  create() {
    ...
    const text = '弹珠之城是一款子弹闯关游戏， 玩家通过炮台发射炮弹，击碎砖块来得分并通关。   在每一个地图里，玩家获一定数量的子弹 并可以拖动瞄准器发射子弹。 子弹在触碰到砖块或墙的时候会反射。 子弹撞击到砖块会令其减血。 游戏有选关和排行两个模式。    在选关模式里， 玩家选择一个地图，并用获得的子弹将所有的砖块击碎。';
