...
export default class HelpState extends BackToMenuState {
  ...
  preload(){
    this.game.load.image('para', 'assets/plane/images/SquareFort.png');
  }
  ...
  create() {
    ...
    this.para = this.game.add.sprite(this.game.width / 2, this.game.height - 50, 'para');
    this.para.anchor.setTo(0.5, 0.5);
    this.para.scale.setTo(1, 1);
